...
type
  ...
  { TFreeAddMassOutputDialog }

  TFreeAddMassOutputDialog = class(TForm)
    ComboBox: TComboBox;
    ...
    procedure Label23Resize(Sender: TObject);
  ...
  public { Public declarations }
    ...
    property AngleBeta: single
      read FGetAngleBeta write FSetAngleBeta;
    property Vs: single
      read FGetVs write FSetVs;
    property Om: single
      read FGetOm write FSetOm;
    ...
    property Dat1: single
      read FGetDat1 write FSetDat1;
    property Dat2: single
      read FGetDat2 write FSetDat2;
    property Dat3: single
      read FGetDat3 write FSetDat3;
    property Dat4: single
      read FGetDat4 write FSetDat4;
  end;

var
  FreeAddMassOutputDialog: TFreeAddMassOutputDialog;
...
procedure TFreeAddMassOutputDialog.ViewportRequestExtents(Sender: TObject;
  var Min, Max: T3DCoordinate);
var
  I, J: integer;
begin
...
begin
  ...
  Strings.Add(FFreeship.ProjectSettings.ProjectName + ' L=' + FloatToStrF(
...
procedure TFreeAddMassOutputDialog.Label23Resize(Sender: TObject);
begin
  Label7.Constraints.MinWidth := Label23.Width;
  Label24.Constraints.MinWidth := Label23.Width;
end;
