...
{                                                                                             }
{#############################################################################################}
unit FreeHydrodyn_Task2Dlg;
// Позиционные хар-ки корпусов
interface
...
type TFreeHydrodyn_Task2  = class(TForm)
...
var FreeHydrodyn_Task2: TFreeHydrodyn_Task2;
...
function TFreeHydrodyn_Task2.FGetDat2:single;
begin
   Result:=Edit2.Value;
end;{TFreeHydrodyn_Task2.FGetDat2}

procedure TFreeHydrodyn_Task2.FSetDat2(val:single);
begin
   Edit2.Value:=val;
end;{TFreeHydrodyn_Task2.FSetDat2}

function TFreeHydrodyn_Task2.FGetDat3:single;
begin
   Result:=Edit3.Value;
end;{TFreeHydrodyn_Task2.FGetDat3}

procedure TFreeHydrodyn_Task2.FSetDat3(val:single);
begin
   Edit3.Value:=val;
end;{TFreeHydrodyn_Task2.FSetDat3}

function TFreeHydrodyn_Task2.FGetDat4:single;
begin
   Result:=Edit4.Value;
end;{TFreeHydrodyn_Task2.FGetDat4}

procedure TFreeHydrodyn_Task2.FSetDat4(val:single);
begin
   Edit4.Value:=val;
   if (Edit4.Value=0) or (Edit4.Value>25.0) then Edit4.Value:=1.0;
end;{TFreeHydrodyn_Task2.FSetDat4}

function TFreeHydrodyn_Task2.FGetDat5:single;
begin
   Result:=Edit5.Value;
end;{TFreeHydrodyn_Task2.FGetDat5}

procedure TFreeHydrodyn_Task2.FSetDat5(val:single);
begin
   Edit5.Value:=val;
   if (Edit5.Value=0) or (Edit5.Value>25) then Edit5.Value:=1.0;
end;{TFreeHydrodyn_Task2.FSetDat5}

function TFreeHydrodyn_Task2.FGetDat6:single;
begin
   Result:=Edit6.Value;
end;{TFreeHydrodyn_Task2.FGetDat6}

procedure TFreeHydrodyn_Task2.FSetDat6(val:single);
begin
   Edit6.Value:=val;
   if (Edit6.Value<=0.3)  or (Edit6.Value>1) then Edit6.Value:=0.65;
end;{TFreeHydrodyn_Task2.FSetDat6}

function TFreeHydrodyn_Task2.FGetDat7:single;
begin
   Result:=Edit7.Value;
end;{TFreeHydrodyn_Task2.FGetDat7}

procedure TFreeHydrodyn_Task2.FSetDat7(val:single);
begin
   Edit7.Value:=val;
end;{TFreeHydrodyn_Task2.FSetDat7}

function TFreeHydrodyn_Task2.FGetDat8:single;
begin
   Result:=Edit8.Value;
end;{TFreeHydrodyn_Task2.FGetDat8}

procedure TFreeHydrodyn_Task2.FSetDat8(val:single);
begin
   Edit8.Value:=val;
   if (Edit8.Value<=0) or (Edit8.Value>60) then Edit8.Value:=49;
end;{TFreeHydrodyn_Task2.FSetDat8}

function TFreeHydrodyn_Task2.FGetDat9:single;
begin
   Result:=Edit9.Value;
end;{TFreeHydrodyn_Task2.FGetDat9}

procedure TFreeHydrodyn_Task2.FSetDat9(val:single);
begin
   Edit9.Value:=val;
   if (Edit9.Value<=0) or (Edit9.Value>45) then Edit9.Value:=5.;
end;{TFreeHydrodyn_Task2.FSetDat9}

function TFreeHydrodyn_Task2.FGetDat10:single;
begin
   Result:=Edit10.Value;
end;{TFreeHydrodyn_Task2.FGetDat10}

procedure TFreeHydrodyn_Task2.FSetDat10(val:single);
begin
   Edit10.Value:=val;
   if (Edit10.Value<=0) or (Edit10.Value>2000) then Edit10.Value:=1025;
end;{TFreeHydrodyn_Task2.FSetDat10}

function TFreeHydrodyn_Task2.FGetDat11:single;
begin
   Result:=Edit11.Value;
end;{TFreeHydrodyn_Task2.FGetDat11}

procedure TFreeHydrodyn_Task2.FSetDat11(val:single);
begin
   Edit11.Value:=val;
   if (Edit11.Value<=0) or (Edit11.Value>3) then Edit11.Value:=1.61;
end;{TFreeHydrodyn_Task2.FSetDat11}

function TFreeHydrodyn_Task2.FGetDat12:single;
begin
   Result:=Edit12.Value;
end;{TFreeHydrodyn_Task2.FGetDat12}

procedure TFreeHydrodyn_Task2.FSetDat12(val:single);
begin
   Edit12.Value:=val;
   if (Edit12.Value=0) or (Edit12.Value>1) then Edit12.Value:=0.25;
end;{TFreeHydrodyn_Task2.FSetDat12}

function TFreeHydrodyn_Task2.FGetDat13:single;
begin
   Result:=Edit13.Value;
end;{TFreeHydrodyn_Task2.FGetDat13}

procedure TFreeHydrodyn_Task2.FSetDat13(val:single);
begin
   Edit13.Value:=val;
   if (Edit13.Value<=0) or (Edit13.Value>1000) then Edit13.Value:=1000;
end;{TFreeHydrodyn_Task2.FSetDat13}

function TFreeHydrodyn_Task2.FGetDat14:single;
begin
   Result:=Edit14.Value;
end;{TFreeHydrodyn_Task2.FGetDat14}

procedure TFreeHydrodyn_Task2.FSetDat14(val:single);
begin
   Edit14.Value:=val;
   if (Edit14.Value=0) or (Edit14.Value>100) then Edit14.Value:=2.5;
end;{TFreeHydrodyn_Task2.FSetDat14}

function TFreeHydrodyn_Task2.FGetDat15:single;
begin
   Result:=Edit15.Value;
end;{TFreeHydrodyn_Task2.FGetDat15}

procedure TFreeHydrodyn_Task2.FSetDat15(val:single);
begin
   Edit15.Value:=val;
   if (Edit15.Value<=0) or (Edit15.Value>1) then Edit15.Value:=0.02;
end;{TFreeHydrodyn_Task2.FSetDat15}

function TFreeHydrodyn_Task2.FGetDat16:single;
begin
   Result:=Edit16.Value;
end;{TFreeHydrodyn_Task2.FGetDat16}

procedure TFreeHydrodyn_Task2.FSetDat16(val:single);
begin
   Edit16.Value:=val;
   if (Edit16.Value<=0) or (Edit16.Value>1) then Edit16.Value:=0.01;
end;{TFreeHydrodyn_Task2.FSetDat16}

function TFreeHydrodyn_Task2.FGetDat17:single;
begin
   Result:=Edit17.Value;
end;{TFreeHydrodyn_Task2.FGetDat17}

procedure TFreeHydrodyn_Task2.FSetDat17(val:single);
begin
   Edit17.Value:=val;
   if (Edit17.Value<0) or (Edit17.Value>2.1) then Edit17.Value:=1;
end;{TFreeHydrodyn_Task2.FSetDat17}

function TFreeHydrodyn_Task2.FGetDat18:single;
begin
   Result:=Edit18.Value;
end;{TFreeHydrodyn_Task2.FGetDat18}

procedure TFreeHydrodyn_Task2.FSetDat18(val:single);
begin
   Edit18.Value:=val;
   if (Edit18.Value<0) or (Edit18.Value>2) then Edit18.Value:=1.0;
end;{TFreeHydrodyn_Task2.FSetDat18}

function TFreeHydrodyn_Task2.FGetDat19:single;
begin
   Result:=Edit19.Value;
end;{TFreeHydrodyn_Task2.FGetDat19}

procedure TFreeHydrodyn_Task2.FSetDat19(val:single);
begin
   Edit19.Value:=val;
   if (Edit19.Value<0) or (Edit19.Value>2.1) then Edit19.Value:=1.0;
end;{TFreeHydrodyn_Task2.FSetDat19}

function TFreeHydrodyn_Task2.FGetDat20:single;
begin
   Result:=Edit20.Value;
end;{TFreeHydrodyn_Task2.FGetDat20}

procedure TFreeHydrodyn_Task2.FSetDat20(val:single);
begin
   Edit20.Value:=val;
   if (Edit20.Value=0) or (Edit20.Value>45) then Edit20.Value:=10.0;
end;{TFreeHydrodyn_Task2.FSetDat20}

procedure TFreeHydrodyn_Task2.Calculate;
...
//  Определяем каталог с программой Task2PP
...
// Запускаем программу расчета
      FileToFind := FileSearch('Exec/Pos_Ship.EXE', FInitDirectory);
	  if FileToFind<>FInitDirectory+'Exec/Pos_Ship.EXE' then begin
	    MessageDlg('Нет файла Pos_Ship.EXE для расчета!!!',mtError,[mbOk],0); 
		exit;
	  end;	
      WinExec(PChar(FInitDirectory+'Exec/Pos_Ship.EXE '),1);
      FileName:='OUT.';
...
//         ResultsMemo.Lines.Add('----------------------------------------------------------------------------------');		 
      ...
      while not Eof(FFile) do
        ...
        CloseFile(FFile);
	  for ii:=1 to 5 do ResultsMemo.Lines.Add(Space(14)+str_[II]);			
	  for ii:=14 to 62 do ResultsMemo.Lines.Add(Space(14)+str_[II]);
      ...
      Jst2:=148;	  
      Jst3:=172;	  	  
      for ii:=Jst1 to Ist1 do ResultsMemo.Lines.Add(Space(14)+str_[II]);
	  for ii:=Jst2 to Ist2 do ResultsMemo.Lines.Add(Space(14)+str_[II]);
      for ii:=Jst3 to Ist3 do ResultsMemo.Lines.Add(Space(14)+str_[II]);
	  for ii:=5 to 12 do ResultsMemo.Lines.Add(Space(14)+str_[II]);				  	  
         ResultsMemo.Lines.Add('');
         ResultsMemo.Lines.Add('');		 
         ResultsMemo.Lines.Add(Space(14)+'Copyright (c) 2008, Timoshenko V.F.');
		 
        if FileExists('INM.') then  DeleteFile('INM.');  		 
        if FileExists('OUT.') then  DeleteFile('OUT.');  
   end;    
  end; 
end;{TFreeHydrodyn_Task2.Calculate}

function TFreeHydrodyn_Task2.Execute(Freeship:TFreeship;AutoExtract:Boolean):Boolean;
begin
   FFreeship:=Freeship;
...
end;{TFreeHydrodyn_Task2.Execute}

procedure TFreeHydrodyn_Task2.ToolButton17Click(Sender: TObject);
...
//      ResultsMemo.Lines.Add(FOpenDirectory+'freeship.exe');
      File_ExportData(dat); 
// Запускаем программу расчета
      WinExec(PChar(FOpenDirectory+'Exec/Task2PP.EXE'),1);
	  sleep(500);
end;{TFreeHydrodyn_Task2.ToolButton17Click}

procedure TFreeHydrodyn_Task2.ToolButton7Click(Sender: TObject);
begin
   ModalResult:=mrCancel;
end;{TFreeHydrodyn_Task2.ToolButton7Click}

procedure TFreeHydrodyn_Task2.ToolButton25Click(Sender: TObject);
begin
  ModalResult:=mrOK;
end;{TFreeHydrodyn_Task2.ToolButton25Click}

procedure TFreeHydrodyn_Task2.Edit1AfterSetValue(Sender: TObject);
begin
   if Checkbox2.Checked then CheckBox2Click(self)
                        else calculate;
end;{TFreeHydrodyn_Task2.Edit1AfterSetValue}

procedure TFreeHydrodyn_Task2.PrintButtonClick(Sender: TObject);
var Line      : Integer;
    PrintText : TextFile;
begin
...
end;{TFreeHydrodyn_Task2.PrintButtonClick}

procedure TFreeHydrodyn_Task2.CheckBox2Click(Sender: TObject);
...
end;{TFreeHydrodyn_Task2.CheckBox2Click}

procedure TFreeHydrodyn_Task2.CheckBox3Click(Sender: TObject);
begin
...
procedure TFreeHydrodyn_Task2.CheckBox4Click(Sender: TObject);
begin
...
procedure TFreeHydrodyn_Task2.CheckBox5Click(Sender: TObject);
var HydObject:TFreeHydrostaticCalc;
begin
...
procedure TFreeHydrodyn_Task2.File_ExportData(dat:array of single);
var I,J        : integer;
    ffile      : textfile;
begin
      Assignfile(FFile,'INM.');
      {$I-}Rewrite(FFile);{$I+}
         Write(FFile,dat[0]:12:6);
         Write(FFile,dat[1]:12:6);		 
		 Write(FFile,dat[2]:12:6);
		 Write(FFile,dat[3]:12:6);
		 Write(FFile,dat[4]:12:6);
		 Write(FFile,dat[5]:12:4);
		 Write(FFile,dat[13]:12:6);
         Writeln(FFile,dat[16]:2:0);		 
         Write(FFile,dat[6]:12:6);		 
         Write(FFile,dat[7]:12:6);		 		 
         ...
         CloseFile(FFile);
         if FileExists('OUT.') then DeleteFile('OUT.');		 
end;{TFreeHydrodyn_Task2.File_IExportData}
