...
{  Panel28.Color := Tabsheet1.ActualColor;
  Panel30.Color := Tabsheet1.ActualColor;
  Panel31.Color := Tabsheet1.ActualColor;
  Panel34.Color := Tabsheet1.ActualColor;
  Panel38.Color := Tabsheet1.ActualColor;
  Panel40.Color := Tabsheet1.ActualColor;
  Panel42.Color := Tabsheet1.ActualColor;
  Panel44.Color := Tabsheet1.ActualColor;
  Panel48.Color := Tabsheet1.ActualColor;
  PanelGlobalImportDir.Color := Tabsheet1.ActualColor;
  }
