...
type
  ...
  { TFreePropeller_Task4 }

  TFreePropeller_Task4 = class(TForm)
...
var
  FreePropeller_Task4: TFreePropeller_Task4;
...
begin
  Edit4.Value := val;
  if (Edit4.Value = 0) or (Edit4.Value > 2.0) then
    Edit4.Value := 1.0;
...
begin
  Edit5.Value := val;
  if (Edit5.Value < 3) or (Edit5.Value > 7) then
    Edit5.Value := 4.0;
...
begin
  Edit6.Value := val;
  if (Edit6.Value <= 0.3) or (Edit6.Value > 1.5) then
    Edit6.Value := 0.55;
...
begin
  Edit7.Value := val;
  if (Edit7.Value <= 0.4) or (Edit7.Value > 1.6) then
    Edit7.Value := 0.9;
...
begin
  Edit8.Value := val;
  if (Edit8.Value <= 0) or (Edit8.Value > 25) then
    Edit8.Value := 1;
...
begin
  Edit9.Value := val;
  if (Edit9.Value <= 0) or (Edit9.Value > 0.45) then
    Edit9.Value := 0.2;
...
begin
  Edit10.Value := val;
  if (Edit10.Value <= 0) or (Edit10.Value > 25) then
    Edit10.Value := 2.5;
...
begin
  Edit12.Value := val;
  if (Edit12.Value = 0) or (Edit12.Value > 10) then
    Edit12.Value := 5.;
...
begin
  Edit13.Value := val;
  if (Edit13.Value <= 0) or (Edit13.Value > 30) then
    Edit13.Value := 5;
...
begin
  Edit14.Value := val;
  if (Edit14.Value = 0) or (Edit14.Value > 1.1) then
    Edit14.Value := 0.99;
...
begin
  Edit16.Value := val;
  if (Edit16.Value = 0) or (Edit16.Value > 1) then
    Edit16.Value := 0.98;
...
{         ResultsMemo.Lines.Add(Space(18)+FloatToStrF(dat[2],ffFixed,6,3));
  ...
  ResultsMemo.Lines.Add('');
  ResultsMemo.Lines.Add(
    Space(18) + 'Copyright (c) 1997, M. G. Parsons (POP v1.5)');
...
{$I+}
  ...
  CloseFile(FFile);
  if FileExistsUTF8('POPGR.') { *Converted from FileExists* } then
    DeleteFileUTF8('POPGR.'); { *Converted from DeleteFile* }
