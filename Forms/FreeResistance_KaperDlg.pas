...
type
  ...
  TFreeResistance_Kaper = class(TForm)
...
var
  FreeResistance_Kaper: TFreeResistance_Kaper;
...
const
  Table1A: array[0..16, 0..13] of
    double = ((1.00, 1.00, 1.00, 1.00, 1.01, 1.05, 1.05, 1.13, 1.62, 1.61,
    1.55, 1.54, 1.52, 1.52),
    (1.06, 1.06, 1.06, 1.05,
    1.00, 1.03, 1.02, 1.15, 1.56, 1.51, 1.49, 1.47, 1.45, 1.45),
    (1.10, 1.10, 1.10, 1.10,
    1.04, 1.04, 1.03, 1.14, 1.45, 1.41, 1.40, 1.41, 1.41, 1.41),
    (1.15, 1.15, 1.15, 1.16,
    1.06, 1.02, 1.07, 1.07, 1.36, 1.35, 1.36, 1.36, 1.34, 1.34),
    (1.17, 1.17, 1.17, 1.15,
    1.05, 1.00, 1.00, 1.04, 1.25, 1.28, 1.32, 1.30, 1.29, 1.29),
    (1.25, 1.25, 1.25, 1.25,
    1.05, 1.01, 1.01, 1.06, 1.23, 1.22, 1.24, 1.24, 1.23, 1.23),
    (1.23, 1.23, 1.23, 1.23,
    1.00, 1.02, 1.02, 1.01, 1.16, 1.16, 1.19, 1.19, 1.18, 1.18),
    (1.27, 1.27, 1.27, 1.25,
    1.01, 1.02, 1.03, 1.00, 1.00, 1.09, 1.13, 1.13, 1.13, 1.13),
    (1.32, 1.32, 1.32, 1.31,
    1.05, 1.03, 1.10, 1.03, 1.10, 1.07, 1.09, 1.09, 1.09, 1.09),
    (1.35, 1.35, 1.35, 1.33,
    1.05, 1.08, 1.15, 1.06, 1.11, 1.06, 1.07, 1.06, 1.06, 1.06),
    (1.33, 1.33, 1.33, 1.33,
    1.02, 1.06, 1.20, 1.10, 1.11, 1.05, 1.05, 1.04, 1.05, 1.05),
    (1.38, 1.38, 1.38, 1.36,
    1.06, 1.09, 1.30, 1.21, 1.12, 1.03, 1.03, 1.03, 1.04, 1.04),
    (1.40, 1.40, 1.40, 1.34,
    1.08, 1.13, 1.38, 1.28, 1.09, 1.02, 1.00, 1.00, 1.02, 1.02),
    (1.42, 1.42, 1.42, 1.38,
    1.12, 1.18, 1.48, 1.39, 1.19, 1.02, 1.01, 1.03, 1.03, 1.03),
    (1.42, 1.42, 1.42, 1.39,
    1.07, 1.17, 1.55, 1.43, 1.20, 1.00, 1.00, 1.02, 1.03, 1.03),
    (1.53, 1.53, 1.53, 1.51,
    1.18, 1.26, 1.72, 1.54, 1.27, 1.01, 1.00, 1.01, 1.02, 1.02),
    (1.48, 1.48, 1.48, 1.49,
    1.22, 1.27, 1.80, 1.63, 1.32, 1.02, 1.00, 1.00, 1.00, 1.00));
  Table1B: array[0..16, 0..13] of
    double = ((1.00, 1.00, 1.00, 1.00, 1.00, 1.08, 1.05, 1.20, 1.45, 1.44,
    1.42, 1.43, 1.40, 1.40),
    (1.05, 1.05, 1.05, 1.04,
    1.00, 1.07, 1.01, 1.18, 1.34, 1.38, 1.36, 1.37, 1.32, 1.32),
    (1.09, 1.09, 1.09, 1.08,
    1.01, 1.06, 1.02, 1.11, 1.26, 1.29, 1.30, 1.30, 1.28, 1.28),
    (1.14, 1.14, 1.14, 1.11,
    1.03, 1.03, 1.02, 1.09, 1.17, 1.24, 1.24, 1.25, 1.24, 1.24),
    (1.15, 1.15, 1.15, 1.13,
    1.02, 1.00, 1.00, 1.01, 1.12, 1.19, 1.22, 1.22, 1.20, 1.20),
    (1.21, 1.21, 1.21, 1.17,
    1.01, 1.02, 1.03, 1.01, 1.06, 1.14, 1.16, 1.16, 1.15, 1.15),
    (1.23, 1.23, 1.23, 1.17,
    1.00, 1.05, 1.07, 1.01, 1.01, 1.11, 1.14, 1.13, 1.13, 1.13),
    (1.25, 1.25, 1.25, 1.19,
    1.00, 1.06, 1.12, 1.00, 1.00, 1.08, 1.08, 1.09, 1.10, 1.10),
    (1.29, 1.29, 1.29, 1.21,
    1.01, 1.07, 1.21, 1.07, 1.00, 1.06, 1.07, 1.07, 1.07, 1.07),
    (1.30, 1.30, 1.30, 1.24,
    1.03, 1.13, 1.29, 1.11, 1.01, 1.05, 1.06, 1.06, 1.06, 1.06),
    (1.29, 1.29, 1.29, 1.24,
    1.02, 1.14, 1.35, 1.22, 1.02, 1.02, 1.04, 1.04, 1.05, 1.05),
    (1.32, 1.32, 1.32, 1.27,
    1.02, 1.17, 1.50, 1.31, 1.04, 1.00, 1.03, 1.04, 1.04, 1.04),
    (1.38, 1.38, 1.38, 1.31,
    1.05, 1.24, 1.59, 1.39, 1.07, 1.02, 1.03, 1.03, 1.03, 1.03),
    (1.38, 1.38, 1.38, 1.33,
    1.09, 1.28, 1.74, 1.58, 1.12, 1.02, 1.02, 1.03, 1.02, 1.02),
    (1.36, 1.36, 1.36, 1.33,
    1.05, 1.30, 1.87, 1.64, 1.15, 1.01, 1.01, 1.01, 1.02, 1.02),
    (1.48, 1.48, 1.48, 1.41,
    1.13, 1.39, 2.06, 1.74, 1.20, 1.02, 1.00, 1.01, 1.01, 1.01),
    (1.45, 1.45, 1.45, 1.40,
    1.18, 1.43, 2.17, 1.89, 1.29, 1.04, 1.00, 1.00, 1.00, 1.00));
  Table1C: array[0..16, 0..13] of
    double = ((1.00, 1.00, 1.00, 1.00, 1.01, 1.10, 1.07, 1.27, 1.43, 1.44,
    1.38, 1.39, 1.41, 1.41),
    (1.06, 1.06, 1.06, 1.01,
    1.00, 1.05, 1.02, 1.20, 1.31, 1.34, 1.34, 1.33, 1.31, 1.31),
    (1.09, 1.09, 1.09, 1.06,
    1.02, 1.05, 1.02, 1.13, 1.23, 1.31, 1.29, 1.28, 1.29, 1.29),
    (1.14, 1.14, 1.14, 1.06,
    1.03, 1.02, 1.00, 1.08, 1.16, 1.25, 1.23, 1.23, 1.23, 1.23),
    (1.18, 1.18, 1.18, 1.09,
    1.01, 1.00, 1.02, 1.00, 1.11, 1.19, 1.20, 1.19, 1.18, 1.18),
    (1.20, 1.20, 1.20, 1.10,
    1.00, 1.01, 1.07, 1.01, 1.06, 1.14, 1.15, 1.15, 1.14, 1.14),
    (1.23, 1.23, 1.23, 1.11,
    1.00, 1.04, 1.14, 1.02, 1.05, 1.12, 1.12, 1.12, 1.12, 1.12),
    (1.23, 1.23, 1.23, 1.15,
    1.00, 1.07, 1.20, 1.04, 1.00, 1.08, 1.08, 1.09, 1.11, 1.11),
    (1.29, 1.29, 1.29, 1.15,
    1.00, 1.11, 1.32, 1.09, 1.01, 1.05, 1.07, 1.07, 1.10, 1.10),
    (1.30, 1.30, 1.30, 1.18,
    1.03, 1.15, 1.41, 1.18, 1.01, 1.03, 1.04, 1.06, 1.08, 1.08),
    (1.26, 1.26, 1.26, 1.19,
    1.00, 1.18, 1.48, 1.29, 1.00, 1.01, 1.04, 1.05, 1.06, 1.06),
    (1.36, 1.36, 1.36, 1.22,
    1.02, 1.21, 1.66, 1.36, 1.06, 1.00, 1.02, 1.04, 1.04, 1.04),
    (1.37, 1.37, 1.37, 1.27,
    1.05, 1.29, 1.79, 1.52, 1.11, 1.02, 1.02, 1.03, 1.03, 1.03),
    (1.40, 1.40, 1.40, 1.28,
    1.09, 1.34, 1.97, 1.65, 1.14, 1.01, 1.00, 1.02, 1.02, 1.02),
    (1.38, 1.38, 1.38, 1.25,
    1.06, 1.38, 2.13, 1.67, 1.20, 1.01, 1.00, 1.01, 1.01, 1.01),
    (1.48, 1.48, 1.48, 1.34,
    1.12, 1.46, 2.34, 1.91, 1.25, 1.03, 1.00, 1.00, 1.01, 1.01),
    (1.47, 1.47, 1.47, 1.32,
    1.17, 1.51, 2.47, 2.08, 1.33, 1.07, 1.00, 1.00, 1.00, 1.00));
  Table4: array[0..4, 0..14] of
    double = ((1.00000, 1.00000, 1.00000, 1.0000, 1.0000, 1.0000, 1.0000,
    1.000, 1.0000, 1.0000, 1.0000, 1.0000, 1.000, 1.00, 1.00),
    (1.01590, 1.01590,
    1.01627, 1.0170, 1.0175, 1.0179, 1.0176, 1.017, 1.0155, 1.0126,
    1.0000, 0.9752, 0.950, 0.93, 0.93),
    (1.01775, 1.01775,
    1.01800, 1.0185, 1.0190, 1.0190, 1.0190, 1.019, 1.0180, 1.0150,
    1.0011, 0.9784, 0.950, 0.93, 0.93),
    (1.02750, 1.02750,
    1.02800, 1.0290, 1.0300, 1.0300, 1.0300, 1.030, 1.0270, 1.0230,
    1.0075, 0.9821, 0.965, 0.95, 0.95),
    (1.04562, 1.04562,
    1.04591, 1.0465, 1.0471, 1.0470, 1.0460, 1.044, 1.0380, 1.0310,
    1.0080, 0.9875, 0.970, 0.96, 0.96));
...
begin
  Edit10.Value := val;
  if (val < 0.0) and (val > 0.04)
     then Edit10.Color:=clYellow
     else Edit10.Color:=clDefault;
...
begin
  ...
  if (EffectiveLengthWaterline = 0) or (BeamWaterline = 0) or (Draft = 0) or
    (WetArea = 0) or (Cp = 0) or (Displacement = 0) or (LCB <= 0) then
    exit;
  ...
  begin
    ...
    begin
      ...
      else if (1000 * Cv >= 1.5) and (1000 * Cv < 2.0) then
        Table2[I][J] := (Table1C[I][J] - Table1B[I][J]) * (1000 * Cv - 1) + Table1B[I][J]
      else if 1000 * Cv >= 2.0 then
        Table2[I][J] := Table1C[I][J]
      else
        Table2[I][J] := Table1A[I][J];
    end;
  end;
  ...
  begin
    ...
    // Calculate C1
    C1 := 0.002 * Power(BeamWaterline / EffectiveLengthWaterline, 0.5) *
      Power(4 * SpeedLengthRatio, 4);
    // Calculate C2
    C2 := 0.005 * (SIN(Ie * 0.01745)) * Power(4 * SpeedLengthRatio, 2);
    // calculate C3
    if SpeedLengthRatio < 1.5 then
      C3 := E20 * COS(F20 * SpeedLengthRatio + G20) + H20
    else
      C3 := 0.7 * E20 * COS(F20 * SpeedLengthRatio + G20) + 0.96 * H20;
    // Calculate C4
    ...
    if (SpeedLengthRatio > 1.4) and (SpeedLengthRatio < 1.6) then
      Tmp := N27
    else if (SpeedLengthRatio >= 1.6) and
      (SpeedLengthRatio < 3) then
      Tmp := O27
    else
      Tmp := 1;
    Rresidual := ((4 * C5 * Displ_longtonnes * Power(Speed, 4) / Sqr(EffectiveLengthWaterline)) +
      C1 + C2) * C3 * C4 * C6 * Tmp;
    ...
    Fact := (0.00871 + 0.053 / (8.8 + EffectiveLengthWaterline)) * WetArea *
      Power(Speed, 1.852) + 0.04;
    ...
    begin
      ...
      begin
        ResultsMemo.Lines.Add(Space(10) + '| ' + Makelength(Speed, 2, 5) + ' | ' +
          // speed in knots
          Makelength(Speed * 1.6878099, 2, 5) + ' | ' +
          // speed in ft/sec
          Makelength(SpeedLengthRatio, 3, 5) + ' | ' +
          // speed/length ratio
          Makelength(RFrictional, 3, 7) + ' | ' +
          // Frictional resistance
          Makelength(RResidual, 3, 7) + ' | ' +
          // Residual resistance
          Makelength(RTotal, 3, 7) + ' | ' +
          // Total resistance
          Makelength(RSpilman, 3, 7) + ' |');
        // Resistance according to Spilman formula
      ...
      begin
        ResultsMemo.Lines.Add(Space(10) + '| ' + Makelength(Speed, 2, 5) + ' | ' +
          // speed in knots
          Makelength(Speed * 1852 / 3600, 2, 5) + ' | ' +
          // speed in m/sec
          Makelength(SpeedLengthRatio, 3, 5) + ' | ' +
          // speed/length ratio
          Makelength(4.44822 * RFrictional, 3, 7) + ' | ' +
          // Frictional resistance
          Makelength(4.44822 * RResidual, 3, 7) + ' | ' +
          // Residual resistance
          Makelength(4.44822 * Rtotal, 3, 7) + ' | ' +
          // Total resistance
          Makelength(4.44822 * RSpilman, 3, 7) + ' |');
        // Resistance according to Spilman formula
...
begin
  ...
  Edit8.ReadOnly := Checkbox2.Checked;
  ...
  begin
    ...
    if Ewl <> 0 then
      LCB := (HydObject.Data.WlMax.X - HydObject.Data.CenterOfBuoyancy.X) / Ewl
    else
      LCB := 0;
